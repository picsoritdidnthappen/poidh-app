...
export default function HighScoresPage() {
  const { data: leaderboardData } = trpc.leaderboard.useQuery();
            ...
            <div className='space-y-3'>
              {leaderboardData?.map(([address, scores], index) => (
                <div
                  ...
                  '
                >
                  <div className='flex items-center gap-3 mb-2 md:mb-0 md:col-span-5 md:gap-0 md:justify-center'>
                  ...
                  <div className='flex flex-col gap-1 md:col-span-7 md:grid md:grid-cols-7 md:items-center md:gap-0'>
                    <div className='flex justify-between md:col-span-2 md:justify-center md:border-l border-white/30 md:text-center'>
                    ...
                    <div className='flex justify-between text-[#F15E5F] md:col-span-1 md:justify-center md:border-l border-white/30 md:text-center'>
