      ...
      <div className='flex flex-row relative items-center gap-x-5'>
        ...
        <div className={`${!walletAddress ? 'opacity-40' : 'opacity-100'}  p-2 w-[40px] h-[40px] wallet  border-[#D1ECFF] border rounded-full backdrop-blur-sm bg-white/30 `}>
          <svg className='w-full' viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                 ...
                 <path d="M10.58 3.96997H6C4.93913 3.96997 3.92178 4.39146 3.17163 5.1416C2.42149 5.89175 2 6.9091 2 7.96997V17.97C2 19.0308 2.42149 20.0482 3.17163 20.7983C3.92178 21.5485 4.93913 21.97 6 21.97H18C19.0609 21.97 20.0783 21.5485 20.8284 20.7983C21.5786 20.0482 22 19.0308 22 17.97V13.8999" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                 <path d="M2 9.96997H5.37006C6.16571 9.96997 6.92872 10.286 7.49133 10.8486C8.05394 11.4112 8.37006 12.1743 8.37006 12.97C8.37006 13.7656 8.05394 14.5287 7.49133 15.0913C6.92872 15.6539 6.16571 15.97 5.37006 15.97H2" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
           </svg>
