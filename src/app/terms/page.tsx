      ...
      <WalletProvider>
        ...
        <section className='px-5 lg:px-20 flex flex-col gap-x-5 text'>
          ...
          <p>
            ...
            These poidh Terms of Service ("Terms") govern your use of the poidh
            platform, which connects bounty posters with users that upload
            photos to claim bounties. By using our platform, you agree to these
            Terms.
          </p>
          ...
          <p>
            The platform is provided "as is". We make no guarantees regarding
            the accuracy, completeness, or reliability of any user-posted
            content.
          </p>

          <h2 className='mt-10 mb-3'>Limitation of Liability</h2>
          <p>
            Pics or it didn’t happen (poidh) or poidh, inc. shall not be liable
