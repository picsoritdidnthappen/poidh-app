...
export function ArbitrumIcon({ size = 24 }: { size?: number }) {
  return (
    ...
    >
      <g id='Layer_x0020_1'>
        <g id='_2405588477232'>
          <rect fill='none' width='20px' height='20px'></rect>
          <g>
            <g>
              <g>
                <path
...
export function ZkPassportIcon({
  width = 24,
  height = 24,
}: {
  width?: number;
...
export function QuestionIcon({ size = 24 }: { size?: number }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
...
export function EarthIcon({ size = 24 }: { size?: number }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
...
export function YouIcon({ size = 24 }: { size?: number }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
...
export function ProfileIcon({ size = 24 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function LeaderboardIcon({ size = 24 }: { size?: number }) {
  return (
    <svg
      height={size}
      width={size}
      ...
      xmlns='http://www.w3.org/2000/svg'
    >
      <g clipPath='url(#clip0_1678_28661)'>
        <path
          d='M8 21H16'
          stroke='white'
          strokeWidth='1.5'
  ...
  return (
    ...
    >
      <g transform='matrix(1,0,0,1,-1259.52,-529.088)'>
        <g>
          <g>
            <g transform='matrix(1.08181,0,0,-1.03277,-108.829,1366.48)'>
              <path
                d='M1394.74,693.463L1330.36,604.024L1330.36,654.238L1394.74,693.463Z'
                style={{
                  fill: 'rgb(200,178,245)',
                  stroke: 'rgb(52,65,192)',
                  strokeWidth: '2.27px',
                }}
              />
            </g>
            <g transform='matrix(-1.08181,0,0,-1.03277,2769.57,1366.48)'>
              <path
                d='M1394.74,693.463L1330.36,604.024L1330.36,654.238L1394.74,693.463Z'
                style={{
                  fill: 'rgb(238,203,192)',
                  stroke: 'rgb(52,65,192)',
                  strokeWidth: '2.27px',
                }}
              />
          ...
          <g>
            <g transform='matrix(-1,0,0,1,2659.32,-0.0263692)'>
              <path
                d='M1398.61,639.614L1328.95,608.641L1328.95,679.249L1398.61,639.614Z'
                style={{
                  fill: 'rgb(135,169,240)',
                  stroke: 'rgb(52,65,192)',
                  strokeWidth: '2.4px',
                }}
              />
            </g>
            <g transform='matrix(1,0,0,1,1.41643,-0.0263692)'>
              <path
                d='M1398.61,639.614L1328.95,608.641L1328.95,679.249L1398.61,639.614Z'
                style={{
                  fill: 'rgb(202,179,245)',
                  stroke: 'rgb(52,65,192)',
                  strokeWidth: '2.4px',
                }}
              />
            </g>
            <g transform='matrix(-1.08181,0,0,1.03277,2769.57,-93.5314)'>
              <path
            ...
            <g transform='matrix(1.08181,0,0,1.03277,-108.829,-93.5314)'>
              <path
                d='M1394.74,709.855L1330.36,604.024L1330.36,679.865L1394.74,709.855Z'
                style={{
                  fill: 'rgb(184,251,246)',
                  stroke: 'rgb(52,65,192)',
                  strokeWidth: '2.27px',
                }}
              />
...
export function MaintenanceIcon({ size = 24 }: { size?: number }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
...
export function ArrowsRightLeftIcon({ size = 24 }: { size?: number }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
...
export function RefundIcon({ size = 24 }: { size?: number }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
